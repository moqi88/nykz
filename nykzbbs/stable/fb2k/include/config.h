...
#define MAX_MAIL_HOLD		 (20000)
#define MAX_BMMAIL_HOLD		(30000)
#define MAX_SYSOPMAIL_HOLD	(50000)
...
#define BBSHOST "bbs.nykz.net"
#define BBSIP	"117.135.131.100"
