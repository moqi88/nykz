...
m_AddTrainingBM(void), m_MinusTrainingBM(void);
#endif
#ifdef ALLOWGAME
int	t_downline();
int x_cal();
...
//							 {"UrgentStart",x_urgent_start,0},//紧急版面开启
//							 {"UrgentStop",x_urgent_stop,0},//紧急版面关系

							 {"GiftDelete",id_gift_delete,0},//礼物删除
...
{"RelInpu",id_relation_input,0},
{"RelReal",id_relation_delete,0},
