...
*/
					...
					{prints ("\033[0;1m[\033[1;33mµµ°¸¹Ý\033[1;32m¹Ý³¤\033[0;1m]");
					}
					else */if(strcmp(buffer,"SYH_Casino")==0)
					{prints ("\033[0;1m[\033[1;33m²©²ÊÖÐÐÄ\033[1;32m¾­Àí\033[0;1m]");
					}
					else if(strcmp(buffer,"SYH_Game")==0)
					{prints ("\033[0;1m[\033[1;33mÓÎÏ·¹ã³¡\033[1;32m¾­Àí\033[0;1m]");
					}
					else
					{
					if (f == 0)
...
//                prints(" [\033[1;32m¼¼ÊõÖÇÄÒ\033[0;1m]");
            if (lookupuser.userlevel & PERM_SPECIAL6)
                prints (" [\033[1;32mµµ°¸¹Ý¹Ý³¤\033[0;1m]");
...
int t_query(char *q_id)
{
    ...
    if (strcasecmp(lookupuser.userid, "guest") != 0)
        sprintf(buf, "[[1;3%dm%s×ù %s[m] ", clr,
...
*/
	   prints("±íÏÖÖµ: [\033[1;32m%d\033[m](\033[1;33m%s\033[m) ÐÅÏä: [\033[1;5;32m%2s\033[m]\n"
...
//nykz
	   ...
	   if (HAS_PERM (PERM_SPECIAL8)|| (strcmp(lookupuser.userid,currentuser.userid)==0)){
		   ...
		   prints("×ÔÓÉ×Ê½ð: [\033[1;32m%dÔª\033[m] ÒøÐÐ´æ¿î: [\033[1;32m%dÔª\033[m](\033[1;33m%s\033[m) ¾­ÑéÖµ: [\033[1;32m%d\033[m](\033[1;33m%s\033[m)¡£\n",
			   lookupuser.money,lookupuser.inbank,
			   cmoney(lookupuser.money + allmoney),exp,cexp(exp));
	   }
	   else
	   {
		   prints("×ÔÓÉ×Ê½ð: [\033[1;32m%dÔª\033[m] ¾­ÑéÖµ: [\033[1;32m%d\033[m](\033[1;33m%s\033[m)¡£\n",
			   lookupuser.money,exp,cexp(exp));
		   
	   }
	   

prints("ÎÄ ÕÂ Êý: [\033[1;32m%d\033[m](\033[1;33m%s\033[m) ½±ÕÂÊý: [\033[1;32m%d\033[m](\033[1;33m%s\033[m) ÉúÃüÁ¦: [\033[1;32m%d\033[m]\n",
...
#else
	   prints("ÎÄ ÕÂ Êý: [\033[1;32m%d\033[m](\033[1;33m%s\033[m) ¾­ÑéÖµ: [\033[1;32m%d\033[m](\033[1;33m%s\033[m) ÉúÃüÁ¦: [\033[1;32m%d\033[m]\n",
		   lookupuser.numposts,cnumposts(lookupuser.numposts), 
    ...
    else if (uinfo.mode == QUERY || uinfo.mode == QAUTHOR)
    {
        ...
        move(t_lines - 1, 0);
        prints
            ("\033[0;1;37;44mÁÄÌì[\033[1;32mt\033[37m] ¼ÄÐÅ[\033[1;32mm\033[37m] ËÍÑ¶Ï¢[\033[1;32ms\033[37m] ¼Ó,¼õÅóÓÑ[\033[1;32mo\033[37m,\033[1;32md\033[37m] Ç×ÆÝ¹ØÏµ²éÑ¯[\033[1;32mq\033[37m] ÓÑÈËÀ¡Ôù²éÑ¯[\033[1;32mi\033[37m]    \033[m");
