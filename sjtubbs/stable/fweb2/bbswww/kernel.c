    ...
    while (s[0])
    {
        ...
        else if (s[0] == '[' && s[1] == '[')
        {
            ...
            *dest++ = '\0';            
            ...
            {    
                printf("<a target='_self' href='/bbsqry?userid=%s'>%s</a>", url_quote(dest), nohtml4(display)); 
            }
            else if (!strcmp(linktype, "Post"))
            {
                ...
                if (filename != NULL)
                {
                    *filename++ = '\0';
                    ...
                    printf("%s'>%s</a>", url_quote(filename), nohtml4(display));
                }
                else
                {
                    goto FMT_ERR;
            ...
            else if (!strcmp(linktype, "Digest"))
            {
                ...
                if (filename != NULL)
                {
                    *filename++ = '\0';
                    ...
                    printf("%%2F%s.html\">%s</a>", url_quote(filename), nohtml4(display));
                }
                else
                {
                    goto FMT_ERR;
            ...
            {
                printf("<a target='_self' href='/wiki/%s'>%s</a>", url_quote(dest), nohtml4(display));
            }
            else
            {
                goto FMT_ERR;
    ...
    while (s[0])
    {
        ...
        else if (s[0] == '[' && s[1] == '[')
        {
            ...
            *dest++ = '\0';            
            ...
            if (!strcmp(linktype, "User"))
            {
                fprintf(stream, "<a target='_self' href='/bbsqry?userid=%s'>%s</a>", url_quote(dest), nohtml4(display));
            }
            else if (!strcmp(linktype, "Post"))
            {
                filename = strchr(dest, ',');
                if (filename != NULL)
                {
                    *filename++ = '\0';
                    ...
                    fprintf(stream, "%s'>%s</a>", url_quote(filename), nohtml4(display));
                }
                else
                {
                    goto FMT_ERR;
            ...
            else if (!strcmp(linktype, "Digest"))
            {
                ...
                if (filename != NULL)
                {
                    *filename++ = '\0';
                    ...
                    fprintf(stream, "%%2F%s.html\">%s</a>", url_quote(filename), nohtml(display));
                }
                else
                {
                    goto FMT_ERR;
            ...
            else if (!strcmp(linktype, "Digdir"))
            {
                ...
                if (filename != NULL)
                {
                    *filename++ = '\0';
                    ...
                    fprintf(stream,"%%2F%s.html\">%s</a>", url_quote(filename), nohtml4(display));
                }
                else
                {
                    goto FMT_ERR;
            ...
            {
                fprintf(stream, "<a target='_self' href='/wiki/%s'>%s</a>", url_quote(dest), nohtml(display));
            }
            else
            {
                goto FMT_ERR;
...
void show_dm(char *userid)
{
    ...
    if ((dist < 12) && (dist > 0))
    {
        ...
        printf(" <font class=c32>ÇøÇø³¤</font><font class=c37>]");
    }
    else
