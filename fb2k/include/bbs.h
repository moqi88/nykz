...
#define MONEYADMIN_BOARDNAME	"MoneyAdmin"		//add by pax
#define CROSSADMIN_BOARDNAME	"CrossAdmin"		//add by pax
#define GIFTADMIN_BOARDNAME	"giftadmin"		//add by pax
#define GIFT_BOARDNAME	"gift"		//add by pax
