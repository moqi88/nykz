...
#define MAXBOARD  512  /* Maximum number of boards */
...
#define MAX_MAIL_HOLD		(9000)
#define MAX_BMMAIL_HOLD		(9000)
#define MAX_SYSOPMAIL_HOLD	(9000)
...
#define BBSNAME "南洋客栈BBS"
#define BBSID   "NYKZBBS"
#define BBSHOST "nykz.net"
#define BBSIP	"120.55.116.156"
